...
import { useMatrixConfigurator } from "./matrix_configurator_hook";
import { useRecordObserver } from "@web/model/relational_model/utils";
import {
    productLabelSectionAndNoteField, ProductLabelSectionAndNoteField
} from "@account/components/product_label_section_and_note_field/product_label_section_and_note_field";


export class AccountMoveLineProductField extends ProductLabelSectionAndNoteField {
    static template = "AccountMoveLineProductField";
    setup() {
        super.setup();
...
registry.category("fields").add("aml_product_many2one", {
